...
export declare function generateSeedKeysWeb(size: number): SpendKeypair;
export declare function getRandomBytes(numBytes: number): Buffer;
...
export declare function generateSignature(message: Buffer, privateKey: Buffer, pubKey: Buffer): string;
export declare function checkSignature(message: Buffer, publicKey: Buffer, signature: {
    r: Buffer;
    c: Buffer;
}): boolean;
